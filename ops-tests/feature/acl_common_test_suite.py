...
class CommonTestSuite:
    ...
    def acl_permit_icmp_hitcount(self, step, step_num):
        ...
        self.print_clr("INFO", "Delaying 10 seconds to allow the acl to be"
                       " applied")
        sleep(10)
        rx_expect = True
        self._create_and_verify_traffic_l3('ICMP', rx_expect)
        ...
        self.print_clr("INFO", "Delaying 20 seconds to allow the hits to show"
                       " up in the osvdb")
        sleep(20)
    ...
    def acl_config_persistance(self, step, step_num, entries_list):
        ...
        for i in list(range(len(entries_list))):
            ...
            self._create_and_verify_traffic_l3('ICMP', rx_expect,
                                               direction=tx_dir[i])
            sleep(20)  # delay to retrieve correct hitcount
        ...
        for i in list(range(len(entries_list))):
            no_acl(self._sw1, self._aclAddrType, acl_name[i])
