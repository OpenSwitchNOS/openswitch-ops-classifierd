...
def configure_acl_test(request, topology):
    ...
    ingress_acl_test.set_secondary_interface_number('2')
    ...
    # Having problems with starting scapy.  The work around is to try at the
    # most twice
    try:
...
def test_acl_permit_any_hs1_hs2_config_persistence_ten_entries(
    ...
    """
    ingress_acl_test.acl_config_persistance(step, 20, entries=10)
#
#     ops1 = topology.get('ops1')
#     hs1 = topology.get('hs1')
#     hs2 = topology.get('hs2')
