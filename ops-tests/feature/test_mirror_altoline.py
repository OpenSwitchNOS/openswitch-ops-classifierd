...
def test_mirror_routing(topology):
    ...
    global wait_time
    wait_time = 5
    print("Rebooting Switch and Hosts")
    ops.libs.reboot.reboot_switch(shell="vtysh")
    hs1.libs.reboot.reboot_workstation(shell="bash")
    hs2.libs.reboot.reboot_workstation(shell="bash")
    sn1.libs.reboot.reboot_workstation(shell="bash")
    global which_test
    which_test = 'routing'
