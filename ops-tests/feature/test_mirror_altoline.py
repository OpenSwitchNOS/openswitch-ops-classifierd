...
def test_mirror_routing(topology):
    ...
    if(test_count == 1):
        sleep(20)
    ops, hs1, hs2, sn1 = setup_topology(topology, 'hw', test_count)
    if(test_count == 1):
        sleep(20)
...
def test_mirror_vlan_docker(topology):
    ...
    which_test = 'vlan'
    global test_count
    ops, hs1, hs2, sn1 = setup_topology(topology, 'docker', test_count)
    sleep(wait_time)
    run_mirror_test(ops, hs1, hs2, sn1)
...
def setup_topology(topology, platform, test_count):
