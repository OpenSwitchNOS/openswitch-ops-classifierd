...
def run_mirror_test(ops, hs1, hs2, sn1):
    ...
    print("########################################")
    print("Test case 2- hs2->hs1, rx mirror on if02")
    print("########################################")
    # Only expect request packets from hs2
    mirror_if02_config(ops, direction='rx')
    ...
    for index, packet in enumerate(packets.split('\n')):
        ...
        if which_test == 'vlan':
            if data['ICMPType'] == 'echo-request':
                if(hs2_ip_info['ip'] == data['srcIP'] and hs1_ip_info['ip'] ==
                   data['dstIP']):
                    passed = True
                else:
                    assert False, "Bad Packet : " + packet
            ...
            if data['ICMPType'] == 'echo-request':
                if(hs2_ip_info['ip'] == data['srcIP'] and hs1_ip_info['ip'] ==
                   data['dstIP'] and data['ethSrc'] == hs2_ip_info['macAddr']
                   and data['ethDst'] == switch_mac_addr and data['ttl'] ==
                   str(default_ttl)):
                    passed = True
                else:
    ...
    print("##############################################################")
    print("Test case 3- hs1->hs2 and hs2->hs1, rx mirror on if01 and if02")
    print("##############################################################")
    # Shutdown other Mirror
    shutdown_mirror_if02_config(ops)
    ...
    print("##########################################")
    print("Test case 4 - hs1->hs2 , tx mirror on if01")
    print("##########################################")
    # Setup mirror
    ...
    print("##########################################")
    print("Test case 5 - hs2->hs1 , tx mirror on if02")
    print("##########################################")
    # Testing Tx, only expect reply packets from hs1
    mirror_if02_config(ops, direction='tx')
    print("Waiting for 2 secs")
    sleep(2)
    start_ping(hs2, hs1_ip_info)
    packets = sn1.send_command(scapy_sniff_command, shell='bash')
    ...
    print("###############################################################")
    print("Test case 6 - hs1->hs2 and hs2->hs1, tx mirror on if01 and if02")
    print("###############################################################")
    ...
    print("###########################################")
    print("Test case 7 - hs1->hs2, both mirror on if01")
    print("###########################################")
    # Setup mirror
    ...
    print("###########################################")
    print("Test case 8 - hs2->hs1, both mirror on if02")
    print("###########################################")
    # Setup Mirror
    mirror_if02_config(ops, direction='both')
    print("Waiting for 2 secs")
    sleep(2)
    ...
    shutdown_mirror_if02_config(ops)
    print("#################################################################")
    print("Test case 9 - hs1->hs2 and hs2->hs1, both mirror on if01 and if02")
    print("#################################################################")
    # Two Source Ports in mirror.
    ...
    print("###############################################################")
    print("Test case 10 - hs1->hs2 and hs2->hs1, tx mirror on if01 and rx ")
    ...
    print("###############################################################")
    print("Test case 11 - hs1->hs2 and hs2->hs1, rx mirror on if01 and tx ")
    print("mirror on if02")
    print("###############################################################")
    # Two Source Ports in mirror.
    ...
    print("###############################################################")
    print("Test case 12 - hs1->hs2 and hs2->hs1, both mirror on if01 and tx ")
    print("mirror on if02")
    print("###############################################################")
    # Two Source Ports in mirror.
    ...
    print("###############################################################")
    print("Test case 13 - hs1->hs2 and hs2->hs1, both mirror on if01 and rx ")
    print("mirror on if02")
    print("###############################################################")
    # Two Source Ports in mirror.
    ...
    print("################################################################")
    print("Test case 14 - hs1->hs2 and hs2->hs1, tx mirror on if01 and both")
    print("mirror on if02")
    print("################################################################")
    # Two Source Ports in mirror.
    ...
    print("################################################################")
    print("Test case 15 - hs1->hs2 and hs2->hs1, rx mirror on if01 and both")
    print("mirror on if02")
    print("################################################################")
    # Two Source Ports in mirror.
