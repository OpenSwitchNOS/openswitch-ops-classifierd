...
from topo_funcs import switch_interface1_ip_address
...
# @mark.test_id(10401)
def test_lag_create_add_apply(configure_lag_l3, topology, step):
    """
    ...
    with ops1.libs.vtysh.ConfigInterfaceLag(lag_id_s1) as ctx:
        ctx.routing()
...
def test_lag_create_add_apply_remove_1member(configure_lag_l3, topology, step):
    """
...
def test_lag_create_add_apply_remove_members(configure_lag_l3, topology, step):
    """
    Create a lag, Add members to lag, Apply ACL to lag, Remove 1 member
    """
    acl_name = 'test'
...
def test_lag_create_add_re_apply_1member(configure_lag_l3, topology, step):
    """
    Create a lag, Add members to lag, Apply ACL to lag, Remove 1 member
    """
    acl_name = 'test'
...
def test_lag_create_add_apply_shut_1member(configure_lag_l3, topology, step):
    """
    Create a lag, Add members to lag, Apply ACL to lag, Remove 1 member
    """
    acl_name = 'test'
