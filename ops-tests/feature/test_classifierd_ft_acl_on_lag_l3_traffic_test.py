...
def test_acl_on_lag_with_one_member(configure_lag_l3, topology, step):
    ...
    teardown_topology(ops2, [interface_list[1]], 'ip', acl_name1, lag_id_s2)
...
def test_acl_on_lag_with_no_members(configure_lag_l3, topology, step):
    ...
    teardown_topology(ops2, [], 'ip', acl_name1, lag_id_s2)
...
def test_bring_down_lag_members_using_pspo_infra(
    ...
    teardown_topology(ops1, interface_list, '', '', lag_id_s1)
    teardown_topology(ops2, [interface_list[0]], 'ip', acl_name1, lag_id_s2)

    step("*****END OF TEST CASE 9*******")


@mark.platform_incompatible(['docker'])
def unsupported_test_config_persistence(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def unsupported_test_egress_acl_on_lag_with_members(configure_lag_l3,
                                                    topology, step):
...
@mark.platform_incompatible(['docker'])
def unsupported_test_egress_acl_on_lag_with_one_member(configure_lag_l3,
                                                       topology, step):
...
@mark.platform_incompatible(['docker'])
def unsupported_est_egress_acl_on_lag_with_no_member(configure_lag_l3,
                                                     topology, step):
...
@mark.platform_incompatible(['docker'])
def unsupported_test_egress_acl_on_lag_with_shut_on_lag(configure_lag_l3,
                                                        topology, step):
...
@mark.platform_incompatible(['docker'])
def unsupported_test_egress_lag_with_no_member_apply_acl(configure_lag_l3,
                                                         topology, step):
...
@mark.platform_incompatible(['docker'])
def unsupported_test_egress_config_persistence(configure_lag_l3,
                                               topology, step):
...
@mark.platform_incompatible(['docker'])
def unsupported_test_egress_replace_acl_out(configure_lag_l3, topology, step):
