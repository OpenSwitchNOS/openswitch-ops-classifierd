...
def test_acl_on_lag_with_no_members(configure_lag_l2, topology, step):
    ...
    teardown_topology(ops2, [], 'ip', test_acl_name, lag_id_s2, vlan_id_s2)
...
def test_acl_on_lag_with_shut_on_all_members(configure_lag_l2,
    ...
    # tear down
    teardown_topology(ops1, interface_list, '', '', lag_id_s1, vlan_id_s1)
    teardown_topology(ops2, interface_list, 'ip', test_acl_name,
                      lag_id_s2, vlan_id_s2)
...
def test_lag_with_no_member_apply_acl(configure_lag_l2, topology, step):
    ...
    # remove lag members from switch-2
    update_lag_members(ops2, interface_list, lag_id_s2, False)
    """
...
def test_config_persistence(configure_lag_l2, topology, step):
...
@mark.platform_incompatible(['docker', 'ostl'])
def test_egress_acl_on_lag_with_members(configure_lag_l2,
                                        topology, step):
...
@mark.platform_incompatible(['docker', 'ostl'])
def test_egress_acl_on_lag_with_one_member(configure_lag_l2,
                                           topology, step):
...
@mark.platform_incompatible(['docker', 'ostl'])
def test_egress_acl_on_lag_with_no_member(configure_lag_l2,
                                          topology, step):
...
@mark.platform_incompatible(['docker', 'ostl'])
def test_egress_acl_on_lag_with_shut_on_lag(configure_lag_l2,
                                            topology, step):
...
@mark.platform_incompatible(['docker', 'ostl'])
def test_egress_lag_with_no_member_apply_acl(configure_lag_l2,
                                             topology, step):
...
@mark.platform_incompatible(['docker', 'ostl'])
def test_egress_config_persistence(configure_lag_l2,
                                   topology, step):
...
@mark.platform_incompatible(['docker', 'ostl'])
def test_egress_replace_acl_out(configure_lag_l2, topology, step):
...
def test_lag_with_no_members_one_acl_add_and_remove_members(
    ...
    # tear down
    teardown_topology(ops1, interface_list, '', '', lag_id_s1, vlan_id_s1)
    teardown_topology(ops2, [], 'ip', test_acl_name,
                      lag_id_s2, vlan_id_s2)
