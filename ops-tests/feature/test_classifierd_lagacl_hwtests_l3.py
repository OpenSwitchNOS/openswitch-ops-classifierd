...
from test_classifierd_ft_acl_tier_2 import reboot_switch
...
TOPOLOGY = topo_defs.topology_2switch_2host_lag_def
...
def test_lag_with_members(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_no_lag_on_one_member(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_no_lag_on_all_members(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_shut_some_member(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_shut_all_member(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_shut_lag(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_lag_with_no_members(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_lag_with_no_members_one_acl(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_pspo_infra_down(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_lag_acl_copy_to_startup_config(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_shut_lag_change_acl_no_shut_lag(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_lag_with_members_out(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_no_lag_on_one_member_out(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_no_lag_on_all_members_out(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_shut_some_member_out(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_shut_all_member_out(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_shut_lag_out(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_lag_with_no_members_out(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_lag_with_no_members_one_acl_out(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_lag_acl_cpy_to_startup_conf_out(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_change_acl_no_shut_lag_out(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_replace_acl_out(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_pspo_infra_up_lag(configure_lag_l3, topology, step):
    ...
    # create an ACL with 511 entries
    create_n_ace_acl(ops2, acl_name2, 512)
    apply_acl(ops2, 'port', '4', 'ip', acl_name2, 'in')
...
@mark.platform_incompatible(['docker'])
def test_pspo_infra_up_acl(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_pspo_infra_down_startup_config(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_lag_no_mmbrs_one_acl_add_remove(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_remove_one_member(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_remove_all_members(configure_lag_l3, topology, step):
...
@mark.platform_incompatible(['docker'])
def test_acl_no_lag_add_lag_verify_acl(configure_lag_l3, topology, step):
