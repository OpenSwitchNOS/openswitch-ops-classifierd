...
def run_lag_mirror_test(ops1, ops2, hs1, hs2, hs3):
    ...
    assert h3_request, "didn't get Host 1 ping request packets" + packets
    assert h1_reply, "didn't get Host 3 ping reply packets" + packets
    packets = ""
    ...
    print("##############################################################")
    print("Test case 4- hs1->hs2 and hs2->hs1, rx mirror on if05 and LAG ")
    print("##############################################################")
