...
def test_lag_mirror_routing(topology):
    ...
    which_test = 'routing'
    global ran_one_test
    ops1, ops2, hs1, hs2, hs3 = setup_topology(topology, ran_one_test)
    run_lag_mirror_test(ops1, ops2, hs1, hs2, hs3)
    sleep(3)
    teardown_hosts(hs1, hs2, hs3)
    ran_one_test = True
...
def setup_topology(topology, ran_one_test):
    ...
    if(ran_one_test is True):
        ...
        ops2.libs.reboot.reboot_switch(shell="vtysh")
    ...
    if(which_test == 'vlan'):
        ...
        hs2_ip_info['ip'] = '10.10.20.1'
        hs2_ip_info['ip_mask'] = '10.10.20.1/24'
        hs3_ip_info['ip'] = '10.10.30.1'
        hs3_ip_info['ip_mask'] = '10.10.30.1/24'
