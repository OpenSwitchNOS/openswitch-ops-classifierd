...
#ifndef _CLS_STATUS_TABLE_H_

#define _CLS_STATUS_TABLE_H_
 ...
 *
 */
extern void cls_status_table_populate(
                   const struct cls_status_entry status_table[],
                   int n_entries);
 ...
 *         returns NULL
 */
extern const char *cls_status_table_get(
                   enum ops_cls_list_status_code status_code);


#endif /* _CLS_STATUS_TABLE_H_ */
