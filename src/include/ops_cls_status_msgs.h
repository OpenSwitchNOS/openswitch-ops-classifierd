 ...
 */
#define OPS_CLS_STATUS_MSG_OP_APPLY_STR    "apply"     /**< string to display
                                                            apply operation
                                                            */
#define OPS_CLS_STATUS_MSG_OP_REMOVE_STR   "remove"    /**< string to display
                                                            remove operation
                                                            */
#define OPS_CLS_STATUS_MSG_OP_REPLACE_STR  "replace"   /**< string to display
                                                            replace operation
                                                            */
#define OPS_CLS_STATUS_MSG_OP_UPDATE_STR   "update"    /**< string to display
                                                            update operation
                                                            */
#define OPS_CLS_STATUS_MSG_OP_GET_STR      "get"       /**< string to display
                                                            get operation
                                                            */
#define OPS_CLS_STATUS_MSG_OP_CLEAR_STR    "clear"     /**< string to display
                                                            clear operation
                                                            */
#define OPS_CLS_STATUS_MSG_OP_CLEARALL_STR "clear all" /**< string to display
                                                            clearall operation
                                                            */
...
#define OPS_CLS_STATUS_MSG_FEATURE_ACL_STR       \
                    "acl"                           /**< string to display acl
                                                         feature */
#define OPS_CLS_STATUS_MSG_FEATURE_ACLLIST_STR   \
                    "acl list"                      /**< string to display acl
                                                         list feature */
#define OPS_CLS_STATUS_MSG_FEATURE_ACL_STAT_STR  \
                    "acl statistics"                /**< string to display acl
                                                         statistics feature */
