...
enum copp_totals {
    COPS_STSTS_TOTAL_PKTS_PASSED = 0,
    COPP_STATS_TOTAL_BYTES_PASSED,
    COPP_STATS_TOTAL_PKTS_DROPPED,
    COPP_STATS_TOTAL_BYTES_DROPPED,
    /***/
    COPS_STSTS_TOTAL_MAX
};

#define COPP_NUM_TOTALS COPS_STSTS_TOTAL_MAX
const char *const temp_copp_totals_keys[COPS_STSTS_TOTAL_MAX] = {
    [COPS_STSTS_TOTAL_PKTS_PASSED] =        "temp_total_pkts_passed",
