...
#define STATS_BUF_SIZE ((NUM_STATS_PER_CLASS*NUM_CHARS_UINT_64) + NUM_COMMAS_AND_SUCH)
    ...
    for (class=0; class < COPP_NUM_CLASSES; class++) {
        /* collect from asic */
        /* FIXME, ASIC 0 is hard-coded. This code was developed before a 'real'
         * plan for multi-asic systems. If you need a multi-asic system, hopefully
         * you have a design and can "do the right thing" here. */
