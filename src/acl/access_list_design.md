...
Conversely, when a lag member link goes up or a new member is added to the LAG,
an ACL entry corresponding to this member is added in hardware.
...
* [Link Aggregation Design document](http://git.openswitch.net/cgit/openswitch/ops/tree/docs/link_aggregation_design.md)